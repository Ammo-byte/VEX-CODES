...
void pushOutForward() {
 pushOut.rotateTo(1375, deg, 50, rpm, true);
}
void pushOutReturn() {
...
void autonomous(void) {
  // // move(3, 75);
  // // stopH();
  // // pushOut.rotateTo(335, deg, 65, rpm, true);
  // // wait(150, msec);
  // // pushOut.rotateTo(0, deg, 70, rpm, true);
  // // wait(100, msec);
  // // lift.rotateTo(275, deg, 100, velocityUnits::pct, true);
  // // wait(100, msec);
  // // lift.rotateTo(0, deg, 100, velocityUnits::pct, true);
  // // wait(50, msec);
  // // intakeM();
  // move(80, 90);
  // stopH();
